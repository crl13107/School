...
public class Tester {
	...
	public static void main(String[] args) {
		...
		Stack<Integer> op = new LinkedStack<Integer>();
		Stack<Double> val = new LinkedStack<Double>();
		/* Create temporary stacks for operators and operands */
		Stack<Integer> optmp = new LinkedStack<Integer>();
		Stack<Double> valtmp = new LinkedStack<Double>();
		/* Accept expression */
...
//String[] name something.split("[\\x]+")
//for each loop to run through it
